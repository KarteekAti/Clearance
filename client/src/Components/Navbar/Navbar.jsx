...
function Navbar() {
    ...
    return (
        <nav className="sticky top-0 z-10 flex flex-row items-center justify-between px-2 py-2 bg-white text-blue-500 ">
                ...
                {user && (
                    <div className={'flex flex-row items-center justify-center sm:px-12 max-w-full gap-6'}>
                        <Link
                            ...
                            className='cursor-pointer px-1 py-2 flex items-center leading-snug hover:opacity-75 hover:underline'>Home
                        </Link>
                        <UserDropdownMenu />
